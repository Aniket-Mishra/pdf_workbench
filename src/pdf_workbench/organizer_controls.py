...
from src.pdf_workbench.workspace import StoredPdf, create_source_manifest


def show_organizer(documents: list[StoredPdf]) -> None:
    st.subheader("Organize pages", anchor="organize-pages")
